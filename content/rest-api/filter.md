...
:::info
Filtering on product properties is also available for the published products.
:::
...
:::info
Filtering on their categories is also available for the published products.
:::
...
```
:::info
Filtering on their status is also available for the published products.
:::
...
```
:::info
Filtering on their completness is also available for the published products.
:::
...
:::info
Filtering on their family is also available on the published products. It is not possible to filter published products on their group. 
:::
...
```
:::info
Filtering on their creation or update date is also available for the published products.
:::
...
:::info
Filtering on product values is also available for the published products.
:::
...
:::info
Filtering product values, vis attributes, channel or locale is also available for the published products.
:::
